...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
        ...
        Route::get('/edit-cat-model/{id}', [CategoryController::class, 'editCatModel'])->name('editCatModel');  // edit in model
        Route::post('/store', [CategoryController::class, 'store'])->name('store');
        Route::post('/model-store', [CategoryController::class, 'modelStore'])->name('model-store'); //Model store
