<header
class="main-header bg-body position-relative d-none d-xl-block px-10 py-6">
<div class="container-fluid">
    <nav class="navbar navbar-light py-0 row no-gutters px-3 px-lg-0">
        ...
        <div
            ...
            <a href="#" class="request-full-screen d-block px-4 mx-3 fs-5"
                title="Full screen">
            ...
            <div class="dropdown px-4 mx-3 py-2 dropdown-language">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item text-brand" href="#"><img
                            src="{{ asset('assets/images/dashboard/flag-us.png') }}"
                            alt="English">English</a>
                    <a class="dropdown-item" href="#"><img
                            src="{{ asset('assets/images/dashboard/flag-fr.png') }}"
                            alt="Français">Français</a>
                    <a class="dropdown-item" href="#"><img
                            src="{{ asset('assets/images/dashboard/flag-jp.png') }}"
                            alt="Français">Français</a>
                    <a class="dropdown-item" href="#"><img
                            src="{{ asset('assets/images/dashboard/flag-cn.png') }}"
                            alt="Français">Français</a>
                </div>
            </div>
