                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle table-nowrap mb-0">
                        <tbody>
                            ...
                            @php
                                $firstImage=$product->images[0]->image_name ?? null;
                            @endphp
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex align-items-center flex-nowrap">
                                            <a href="../shop/product-details-v1.html" title="Flowers cotton dress">
                                                <img src="{{$firstImage ? asset('/images/'.$firstImage) :'' }}"
                                                    data-src="{{$firstImage ? asset('/images/'.$firstImage) :'' }}"
                                                    alt="Flowers cotton dress" class="lazy-image" width="60"
                                                    height="80">
                                            </a>
                                            <a href="../shop/product-details-v1.html" title="Flowers cotton dress"
                                                class="ms-6">
                                                <p class="fw-semibold text-body-emphasis mb-0">{{ $product->title ?? '' }}</p>
                                            </a>
                                        </div>
                                    </td>
                                    <td>{{ $product->price ?? '' }}</td>
