...
<head>
    ...
    <title>Home Page 05 - Glowing - Bootstrap 5 HTML Templates</title>
    ...
    <link rel="stylesheet" href="assets/cdn.jsdelivr.net/npm/bootstrap-icons%401.9.1/font/bootstrap-icons.css">
    <link
...
<body>
    ...
    <header id="header" class="header header-sticky header-sticky-smart disable-transition-all z-index-5">
        <div class="topbar bg-primary">
            <div class="container-wide container">
                <p class="mb-0 text-white text-center p-4 fs-15px fw-bold ls-1 text-uppercase">Free shipping on all U.S.
                    orders $50+</p>
            </div>
        </div>
            ...
            <div class="main-header nav navbar bg-body navbar-light navbar-expand-xl py-6 py-xl-0">
                <div class="container-xxl container">
                        ...
                        <div class="icons-actions d-flex justify-content-end w-xl-50 fs-28px text-body-emphasis w-72px">
                            <div class="px-xl-5 d-inline-block">
                                <a class="lh-1 color-inherit text-decoration-none" href="#"
                                    data-bs-toggle="offcanvas" data-bs-target="#searchModal" aria-controls="searchModal"
                                    aria-expanded="false">
                    ...
                    <div class="d-none d-xl-flex flex-column flex-xl-row w-100">
                        ...
                        <div class="w-auto w-xl-50 d-flex align-items-center ">
                            <ul class="navbar-nav w-100 invisible w-xl-auto">
                                <li
            ...
            <div class="row">
                ...
                <div class="col-lg col-md-4 col-12 mb-11 mb-lg-0">
                    ...
                    <ul class="list-unstyled mb-0 fw-medium ">
                        ...
                        <li class="pt-3 mb-4">
                            <a href="#" title="Terms &amp; Conditions" class="text-body">Terms &amp;
                                Conditions</a>
                        </li>
                ...
                <div class="col-sm-12 col-lg-4 text-md-center order-1 order-lg-2 ">
                    <a class="d-inline-block" href="index.html">
                        ...
                        <img class="lazy-image img-fluid light-mode-img" src="#"
                            data-src="./assets/images/others/logo.png" width="179" height="26"
                            alt="Glowing - Bootstrap 5 HTML Templates">
                        <img class="lazy-image dark-mode-img img-fluid" src="#"
                            data-src="./assets/images/others/logo-white.png" width="179" height="26"
                            alt="Glowing - Bootstrap 5 HTML Templates">
                    </a>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 order-3 text-sm-start text-lg-end mt-11 mt-lg-0">
                    <img src="#" data-src="./assets/images/footer/img_1.png" width="313" height="28"
                        alt="Paypal" class="img-fluid lazy-image">
                </div>
            </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="icon-ShareNetwork" viewBox="0 0 32 32">
            <path fill="none" stroke-linejoin="round" stroke-linecap="round" stroke-miterlimit="4"
                stroke-width="2.4" d="M8 20c2.209 0 4-1.791 4-4s-1.791-4-4-4c-2.209 0-4 1.791-4 4s1.791 4 4 4z"></path>
            <path fill="none" stroke-linejoin="round" stroke-linecap="round" stroke-miterlimit="4"
    ...
    <div id="searchModal" data-bs-scroll="false" class="offcanvas offcanvas-top"
            ...
            <nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
                <div class="col-xl-3 d-flex justify-content-center justify-content-xl-start">
                    <a href="index.html" class="navbar-brand py-4 d-lg-inline-block">
                        <img src="assets/images/others/logo.png" height="26"
                            alt="Glowing - Bootstrap 5 HTML Templates">
                    </a>
                </div>
                <div class="col-xl-6 d-flex justify-content-center">
                    <form class="w-xl-100 w-sm-75 w-100 mt-6 mt-xl-0 px-6 px-xl-0">
                        <div class="input-group mx-auto">
                            <input type="text" class="form-control form-control bg-transparent border-primary"
                    ...
                    <tbody>
                        <tr class="position-relative">
                            ...
                            <td class="shop-product">
                                <div class="d-flex align-items-center">
                                    <div class="me-6">
                                        <img src="assets/images/products/product-03-75x100.jpg" width="60"
                        ...
                        <tr class="position-relative">
                            ...
                            <td class="shop-product">
                                <div class="d-flex align-items-center">
                                    <div class="me-6">
                                        <img src="assets/images/products/product-06-75x100.jpg" width="60"
                                            height="80" alt="natural coconut cleansing oil">
                                    </div>
                                    <div class="">
                                        <p class="card-text mb-1">
                        ...
                        <tr class="position-relative">
                            ...
                            <td class="shop-product">
                                <div class="d-flex align-items-center">
                                    <div class="me-6">
                                        <img src="assets/images/products/product-09-75x100.jpg" width="60"
                                            height="80" alt="natural coconut cleansing oil">
                                    </div>
                                    <div class="">
                                        <p class="card-text mb-1">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-13 px-8">
                    <p class="text-center fs-16 mb-10">Don’t have an account yet? <a href="#"
                            data-bs-toggle="modal" data-bs-target="#signUpModal" class="text-black">Sign up</a>
                        for free</p>
                    <form action="#">
                        <input name="email" type="email" class="form-control mb-5" placeholder="Your email"
                            required>
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-8 mb-7">
                            <div class="custom-control d-flex form-check">
                                <input name="stay-signed-in" type="checkbox"
                                    class="form-check-input rounded-0 me-3" id="staySignedIn">
    ...
    <div class="modal" id="signUpModal" tabindex="-1" aria-labelledby="signUpModal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-13 px-8">
                    <p class="text-center fs-16 mb-10">Already have an account? <a href="#"
                            data-bs-toggle="modal" data-bs-target="#signInModal" class="text-black">Log in</a></p>
                    <form action="#">
                        <input name="first-name" type="text" class="form-control border-1 mb-5"
                            placeholder="First name" required>
                        <input name="last-name" type="text" class="form-control border-1 mb-5"
                            placeholder="Last name" required>
                        <input name="email" type="email" class="form-control border-1 mb-5"
                            placeholder="Your email" required>
                        <input name="password" type="password" class="form-control border-1"
                            placeholder="Password" required>
                        <div class="d-flex align-items-center mt-8 mb-7">
                            <div class="form-check">
                                <input name="agree-policy-terms" type="checkbox"
                                    class="form-check-input rounded-0 me-3" id="agreePolicyTerm">
                                <label class="custom-control-label text-body" for="agreePolicyTerm">Yes, I agree
                                    with
                                    Grace <a href="#" class="text-black">Privacy Policy</a> and <a
                                        href="#" class="text-black">Terms of Use</a></label>
                            </div>
                        </div>
